  ...
  const stats = [
    {
      ...
      value: dashboardData?.enrolledCourses || enrollments.length,
      color: '#1976d2',
      bgColor: 'primary.50',
    },
    {
    ...
    },
    {
      ...
      value: enrollments.reduce((sum, e) => sum + (e.assignments?.length || 0), 0),
      color: '#0288d1',
      bgColor: 'info.50',
    },
  ];
              ...
              <Grid item xs={12} md={6} lg={4} key={enrollment.enrollment_id || enrollment.id}>
                ...
                >
                  <Box
                    sx={{
                      height: 6,
                      background: enrollment.completed_at 
                    ...
                    <Box sx={{ mb: 2 }}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                        ...
                        <Typography 
                          ...
                          sx={{ 
                            fontWeight: 600,
                            color: enrollment.progress >= 100 ? 'success.main' : 'primary.main',
                          }}
                        >
                  ...
                  <CardActions sx={{ p: 2, pt: 0 }}>
                    <Button
                      ...
                      sx={{
                        ...
                        boxShadow: enrollment.completed_at
